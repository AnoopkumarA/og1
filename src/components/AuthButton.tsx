...
export const AuthButton = () => {
  ...
  return user ? (
    <div className="flex items-center gap-3">
      {/* Email display - hidden on mobile, visible on larger screens */}
      ...
      {/* Add Project button - visible on mobile only */}
      <div className="relative group block sm:hidden">
        <div className="absolute -inset-0.5 bg-gradient-to-r from-[#8B5CF6]/20 to-[#0EA5E9]/20 rounded-full blur opacity-75 group-hover:opacity-100 transition-opacity duration-300" />
        <Button
          onClick={() => window.location.href = '/'}
          variant="outline"
          className="text-xs px-2 py-1 bg-gradient-to-r from-purple-500 to-blue-500 hover:from-purple-600 hover:to-blue-600 text-white rounded-full"
        >
          Add Project
        </Button>
      </div>
